  ...
  <div class="wrapper" id="app" v-cloak>
    ...
    <nav id="sidebar" :class="sidebarClass">
      ...
      <ul class="list-unstyled components">
        ...
        <li>
          <router-link to="/terms">Cookies</router-link>
        </li>
        <li>
    ...
    <div class="container" style="padding-left:0px;">
      <nav class="navbar navbar-dark bg-success2">
        <div class="w-100 float-left text-left">
          ...
          <span class="	fa fa-envelope display" style="color:#42b883"></span> <a href="mailto:crucerumihaidaniel@gmail.com" class="display" style="padding-right:15px">  crucerumihaidaniel@gmail.com</a>
             <span class="	fa fa-star display" style="color:#42b883"></span><router-link to="/bookmarked"> Bookmarked recipes</router-link>
